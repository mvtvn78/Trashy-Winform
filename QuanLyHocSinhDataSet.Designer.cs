...
namespace Trashy_WinForm {
    ...
    public partial class QuanLyHocSinhDataSet : global::System.Data.DataSet {
        ...
        public partial class NGUOIDUNGDataTable : global::System.Data.TypedTableBase<NGUOIDUNGRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NGUOIDUNGRow AddNGUOIDUNGRow(string MaNguoiDung, string MaLoai, string TenNguoiDung, string TenDangNhap, string MatKhau) {
            ...
            private void InitClass() {
                ...
                this.columnMaNguoiDung.MaxLength = 6;
        ...
        public partial class NGUOIDUNGRow : global::System.Data.DataRow {
            ...
            public string MaLoai {
                get {
                    return ((string)(this[this.tableNGUOIDUNG.MaLoaiColumn]));
                }
                set {
                    this[this.tableNGUOIDUNG.MaLoaiColumn] = value;
                }
            }
...
namespace Trashy_WinForm.QuanLyHocSinhDataSetTableAdapters {
    ...
    public partial class NGUOIDUNGTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NGUOIDUNG] WHERE (([MaNguoiDung] = @Original_MaNguoiDung) AND " +
                "([MaLoai] = @Original_MaLoai) AND ([TenNguoiDung] = @Original_TenNguoiDung) AND " +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NGUOIDUNG] ([MaNguoiDung], [MaLoai], [TenNguoiDung], [TenDangNhap], [MatKhau]) VALUES (@MaNguoiDung, @MaLoai, @TenNguoiDung, @TenDangNhap, @MatKhau);
SELECT MaNguoiDung, MaLoai, TenNguoiDung, TenDangNhap, MatKhau FROM NGUOIDUNG WHERE (MaNguoiDung = @MaNguoiDung)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NGUOIDUNG] SET [MaNguoiDung] = @MaNguoiDung, [MaLoai] = @MaLoai, [TenNguoiDung] = @TenNguoiDung, [TenDangNhap] = @TenDangNhap, [MatKhau] = @MatKhau WHERE (([MaNguoiDung] = @Original_MaNguoiDung) AND ([MaLoai] = @Original_MaLoai) AND ([TenNguoiDung] = @Original_TenNguoiDung) AND ([TenDangNhap] = @Original_TenDangNhap) AND ([MatKhau] = @Original_MatKhau));
SELECT MaNguoiDung, MaLoai, TenNguoiDung, TenDangNhap, MatKhau FROM NGUOIDUNG WHERE (MaNguoiDung = @MaNguoiDung)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Trashy_WinForm.Properties.Settings.Default.QuanLyHocSinhConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNguoiDung, MaLoai, TenNguoiDung, TenDangNhap, MatKhau FROM dbo.NGUOIDUNG" +
                "";
        ...
        public virtual int Delete(string Original_MaNguoiDung, string Original_MaLoai, string Original_TenNguoiDung, string Original_TenDangNhap, string Original_MatKhau) {
        ...
        public virtual int Insert(string MaNguoiDung, string MaLoai, string TenNguoiDung, string TenDangNhap, string MatKhau) {
            if ((MaNguoiDung == null)) {
        ...
        public virtual int Update(string MaNguoiDung, string MaLoai, string TenNguoiDung, string TenDangNhap, string MatKhau, string Original_MaNguoiDung, string Original_MaLoai, string Original_TenNguoiDung, string Original_TenDangNhap, string Original_MatKhau) {
            if ((MaNguoiDung == null)) {
                throw new global::System.ArgumentNullException("MaNguoiDung");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MaLoai, string TenNguoiDung, string TenDangNhap, string MatKhau, string Original_MaNguoiDung, string Original_MaLoai, string Original_TenNguoiDung, string Original_TenDangNhap, string Original_MatKhau) {
            return this.Update(Original_MaNguoiDung, MaLoai, TenNguoiDung, TenDangNhap, MatKhau, Original_MaNguoiDung, Original_MaLoai, Original_TenNguoiDung, Original_TenDangNhap, Original_MatKhau);
        }
    }
